            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="prose prose-lg max-w-none">
                    <p className="text-lg text-secondary mb-8">
                        These Terms of Service ("Terms") govern your access to and use of <strong>Context Pack</strong>, a service operated by <strong>Context Labs LLC</strong>, a California limited liability company ("Context Labs," "we," "us," or "our"). Context Labs LLC operates the Service under the product name Context Pack.
                    </p>
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">1. Description of the Service</h2>
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">2. Eligibility</h2>
                        <p className="text-secondary">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-secondary mb-3">To access certain features, you may be required to create an account. You agree to:</p>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-secondary mb-3">You agree not to use the Service to:</p>
                        <ul className="list-disc pl-6 space-y-2 text-secondary">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">5. User Content</h2>

                        <h3 className="text-xl font-medium text-primary mb-3 mt-6">5.1 Ownership</h3>
                        <p className="text-secondary">
                            You retain ownership of all data and content you upload to the Service ("User Content").
                        </p>

                        <h3 className="text-xl font-medium text-primary mb-3 mt-6">5.2 License to Process</h3>
                        <p className="text-secondary">
                            You grant Context Labs LLC a limited, non-exclusive license to process User Content solely to provide the Service.
                        </p>

                        <h3 className="text-xl font-medium text-primary mb-3 mt-6">5.3 Responsibility</h3>
                        <p className="text-secondary">
                            You are solely responsible for User Content and represent that you have all necessary rights to upload and process it.
                        </p>
                    </section>

                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">6. No Sensitive Data</h2>
                        <p className="text-secondary mb-3">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">7. AI Limitations and Use of Content</h2>
                        <p className="text-secondary mb-3">
                            <strong>Context Labs LLC does not use User Content to train AI models.</strong> User Content is processed solely to provide the Service.
                        </p>
                        <p className="text-secondary mb-3">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">8. Payments</h2>
                        <p className="text-secondary mb-3">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">10. Service Availability</h2>
                        <p className="text-secondary">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">11. Disclaimer of Warranties</h2>
                        <p className="text-secondary">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">12. Limitation of Liability</h2>
                        <p className="text-secondary mb-3">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">13. Indemnification</h2>
                        <p className="text-secondary">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">14. Security Incidents</h2>
                        <p className="text-secondary">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">15. Copyright / DMCA</h2>
                        <p className="text-secondary mb-3">
                            If you believe copyrighted material has been uploaded without authorization, contact:
                        </p>
                        <div className="space-y-2 text-secondary ml-6">
                            <p><strong>DMCA Agent</strong></p>
                            <p>Email: <a href="mailto:dmca@context-pack.com" className="text-accent hover:underline">dmca@context-pack.com</a></p>
                        </div>
                    </section>

                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">16. Governing Law</h2>
                        <p className="text-secondary">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-primary mb-4">17. Contact</h2>
                        <div className="space-y-2 text-secondary">
                            <p><strong>Context Labs LLC</strong></p>
                            <p>Support: <a href="mailto:support@context-pack.com" className="text-accent hover:underline">support@context-pack.com</a></p>
                            <p>Legal: <a href="mailto:legal@context-pack.com" className="text-accent hover:underline">legal@context-pack.com</a></p>
                        </div>
                    </section>
                </div>
            </div>
