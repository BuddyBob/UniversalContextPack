    ...
    <div className="min-h-screen bg-bg-primary py-12">
      <div className="max-w-4xl mx-auto px-6">
        <div className="bg-bg-card border border-border-primary rounded-lg p-8">
          <h1 className="text-3xl font-semibold text-text-primary mb-2">Privacy Policy</h1>
          ...
          <div className="prose prose-lg max-w-none text-text-primary space-y-8">
            <section>
              <h2 className="text-2xl font-medium text-text-primary mb-4">1. Introduction</h2>
            ...
            <section>
              <h2 className="text-2xl font-medium text-text-primary mb-4">2. Information We Collect</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-text-primary mb-2">2.1 Account Information</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium text-text-primary mb-2">2.2 Conversation Data</h3>
                  <ul className="list-disc list-inside text-text-secondary space-y-1">
                ...
                <div>
                  <h3 className="text-lg font-medium text-text-primary mb-2">2.3 Usage Data</h3>
                  <ul className="list-disc list-inside text-text-secondary space-y-1">
            ...
            <section>
              <h2 className="text-2xl font-medium text-text-primary mb-4">3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-2xl font-medium text-text-primary mb-4">4. Data Storage and Security</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-medium text-text-primary mb-4">5. Data Sharing and Third Parties</h2>
              <div className="space-y-4">
                <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-text-primary mb-4">6. Your Rights and Choices</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-medium text-text-primary mb-4">7. Data Retention</h2>
              <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-text-primary mb-4">8. International Data Transfers</h2>
              <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-text-primary mb-4">9. Changes to This Policy</h2>
              <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-text-primary mb-4">10. Contact Us</h2>
              <p className="text-text-secondary">
