...
export default function PricingPageClient() {
  ...
  const calculatePrice = (credits: number) => {
    if (isUnlimitedSelected) return 2.99 // Unlimited for $2.99
            ...
            <div className="flex justify-center">
              <div className="inline-flex border border-gray-200 rounded-lg p-1 bg-gray-50">
                ...
                >
                  ...
                  <div className={`text-xs mt-0.5 ${isUnlimitedSelected ? 'text-gray-300' : 'text-gray-600'}`}>One-time $2.99</div>
                </button>
              </div>
            </div>
          ...
          {isUnlimitedSelected ? (
            ...
            <div className="max-w-md mx-auto">
              <div className="border border-gray-200 rounded-lg p-8 text-center bg-white">
                ...
                <div className="mb-8">
                  <span className="text-4xl font-semibold text-gray-900">$2.99</span>
