...
export const metadata: Metadata = {
  ...
  description: 'Affordable AI conversation analysis pricing. Pay-per-use credits with volume discounts. Transform your ChatGPT and Claude conversations starting at $0.08 per credit.',
  alternates: {
    canonical: '/pricing'
  },
  openGraph: {
