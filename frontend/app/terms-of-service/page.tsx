    ...
    <div className="min-h-screen bg-primary py-12">
      <div className="max-w-4xl mx-auto px-6">
        <div className="bg-card border border-primary rounded-lg p-8">
          <h1 className="text-3xl font-semibold text-primary mb-2">Terms of Service</h1>
          ...
          <div className="max-w-none text-primary space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">2. Description of Service</h2>
              <p className="text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">3. User Accounts</h2>
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">4. Acceptable Use</h2>
              <div className="space-y-4">
                <p className="text-secondary">You agree not to use the Service to:</p>
                <ul className="list-disc list-inside text-secondary space-y-1">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">5. Content and Data</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-primary mb-2">5.1 Your Content</h3>
                  <p className="text-secondary">
                ...
                <div>
                  <h3 className="text-lg font-medium text-primary mb-2">5.2 Generated Content</h3>
                  <p className="text-secondary">
                ...
                <div>
                  <h3 className="text-lg font-medium text-primary mb-2">5.3 Content Responsibility</h3>
                  <p className="text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">6. Payment and Billing</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-primary mb-2">6.1 Credit System</h3>
                  <p className="text-secondary">
                ...
                <div>
                  <h3 className="text-lg font-medium text-primary mb-2">6.2 Payment Processing</h3>
                  <p className="text-secondary">
                ...
                <div>
                  <h3 className="text-lg font-medium text-primary mb-2">6.3 Price Changes</h3>
                  <p className="text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">7. Service Availability</h2>
              <p className="text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">8. Intellectual Property</h2>
              <p className="text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">9. Privacy</h2>
              <p className="text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">10. Disclaimers and Limitations</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-primary mb-2">10.1 Service Disclaimer</h3>
                  <p className="text-secondary">
                ...
                <div>
                  <h3 className="text-lg font-medium text-primary mb-2">10.2 Limitation of Liability</h3>
                  <p className="text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">11. Termination</h2>
              <p className="text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">12. Changes to Terms</h2>
              <p className="text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">13. Governing Law</h2>
              <p className="text-secondary">
            ...
            <section>
              <h2 className="text-2xl font-medium text-primary mb-4">14. Contact Information</h2>
              <p className="text-secondary">
